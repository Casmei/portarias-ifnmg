<div>
    <a class="cursor-pointer flex space-x-1 border px-3 py-1  border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase" wire:click="confirmDelete('{{ $serverId }}', '{{ $serverName }}')">
