    ...
    <div class="lg:flex m-5 items-center">
        <div class=" mb-5 lg:mb-0 grow lg:w-8/12 me-5">
                <label class="relative block">
                    ...
                    <input wire:model="searchTerm" class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-indigo-300 focus:ring-indigo-300 focus:ring-1 sm:text-sm" placeholder="Buscar servidor pelo nome" type="text"/>
                </label>
        </div>
            ...
            <div class="overflow-hidden">
                ...
                <tr class="border-b border-gray-100">
                    ...
                    <td class="whitespace-nowrap px-6 py-4 flex space-x-2">
                        ...
                        <a href="{{ url('servidores/'.$servidor->id.'/excluir') }}" class="cursor-pointer flex space-x-1 border px-3 py-1  border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase" >
