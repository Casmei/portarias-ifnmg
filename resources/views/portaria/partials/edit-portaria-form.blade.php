<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Forneça as informações que deseja editar da portaria.') }}
        </p>
    </header>
    ...
    <form method="post" action="#" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="portaria-numero" name="numero-portaria" type="text" value="1234567" class="mt-1 block w-full"/>
        ...
        <div>
            ...
            <x-text-input id="campus-ou-reitoria" name="campus-ou-reitoria" type="text" class="mt-1 block w-full" value="Reitoria" />
            {{-- <x-input-error :messages="$errors->get('email')" class="mt-2" /> --}}
        </div>

        <div>
            <x-input-label for="email" :value="__('Descrição')" />
            <textarea class='border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full' rows="4"  id="description" name="description" value="Descrição" > 
