<section>
    ...
    <form method="post" action="{{ route('ordinance.store') }}" class="mt-6 space-y-6"  enctype="multipart/form-data">
        ...
        <div>
            ...
            <x-text-input id="ordinance_number" name="ordinance_number" type="text" placeholder="Ex: 123456" class="mt-1 block w-full"/>
        ...
        <div>
            ...
            <x-text-input id="campus" name="campus" type="text" class="mt-1 block w-full" placeholder="IFNMG - Campus Almenara" />
        ...
        <div>
            ...
            <textarea class='border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full' cols="4"  id="description" name="description" ></textarea>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" checked name="visibility">
