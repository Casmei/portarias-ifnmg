                        ...
                        <div class=" mb-5 lg:mb-0 grow lg:w-8/12 me-5">
                            <form action="{{route('servidores.search')}}" method='get'>
                                ...
                                <label class="relative block">
                                    ...
                                    <input class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-indigo-300 focus:ring-indigo-300 focus:ring-1 sm:text-sm" placeholder="Buscar portaria pelo número" type="text" name="search"/>
                                </label>
                            </form>
                        </div>
                            ...
                            <div class="overflow-hidden">
                                ...
                                <thead class="border-b font-semibold text-gray-800 leading-tight border-gray-200">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-4">VISIBILIDADE</th>
                                ...
                                @foreach ( $portarias as $portaria )
                                    <tr class="border-b border-gray-100">
                                        <td class="whitespace-nowrap px-6 py-4 font-medium">{{ $portaria->ordinance_number }}</td>
                                        <td class="whitespace-nowrap px-6 py-4">{{ $portaria->campus }}</td>
                                        <td class="whitespace-nowrap px-6 py-4">
                                            @if ($portaria->visibility)
                                                <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Publica</span>
                                            @else
                                                <span class="bg-gray-100 text-gray-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">Privada</span>
                                            @endif
                                        </td>
